...
function extend (Y) {
  class WebRTC extends Y.AbstractConnector {
    constructor (y, options) {
      ...
      console.log('WebRTC constructor Options:')
      console.log(options)
      ...
      this.webrtcOptions = {
        ...
        // url: options.url || 'http://localhost:12305',
        room: options.room,
        
        // In order to allow multiple elements on each device using multiple
        // rooms we must use new connections as set below
        socketio: {'force new connection': true}
      }
      console.log('y-webrtcliquid.js')
